...
if __name__ == '__main__':
    ...
    parser.add_argument('--scr_folder',default = 'G:\EPAi\epai_session11\images', help='convert to ')
    parser.add_argument('--dest_folder',default = 'G:\EPAi\epai_session11\modified_images', help='extentions to be converted ')
